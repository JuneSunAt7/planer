...
"border-radius: 15px;")
        ...
        self.todayLbl = QtWidgets.QLabel(self.weekFrame)
        self.todayLbl.setGeometry(QtCore.QRect(40, 30, 71, 41))
        self.todayLbl.setStyleSheet("border-radius: 15px;\n"
"background-color: rgba(0,0,0,0);\n"
"font: 75 12pt \"MS Shell Dlg 2\";")
        self.todayLbl.setObjectName("todayLbl")
        self.todayTableview = QtWidgets.QTableWidget(self.weekFrame)
        self.todayTableview.setGeometry(QtCore.QRect(150, 30, 701, 250))
        self.todayTableview.setStyleSheet("border-radius:15px;\n"
"background-color: qlineargradient(spread:pad, x1:0, y1:0.523, x2:1, y2:0.557, stop:0 rgba(190, 197, 255, 255), stop:1 rgba(174, 255, 192, 255));\n"
"font: 75 14pt \"MS Shell Dlg 2\";")
        self.todayTableview.setObjectName("todayTableview")
        self.todayTableview.setColumnCount(3)
        self.todayTableview.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
        self.todayTableview.setHorizontalHeaderItem(0, item)
        item = QtWidgets.QTableWidgetItem()
        self.todayTableview.setHorizontalHeaderItem(1, item)
        item = QtWidgets.QTableWidgetItem()
        self.todayTableview.setHorizontalHeaderItem(2, item)
        self.todayTableview.setSelectionBehavior(QAbstractItemView.SelectRows)
        self.todayTableview.horizontalHeader().setSectionResizeMode(QHeaderView.Stretch)
        self.todayTableview.setShowGrid(False)
...
"font: 75 16pt \"MS Shell Dlg 2\";")
        ...
        self.mainTasksView.setGeometry(QtCore.QRect(150, 300, 701, 200))
...
"font: 75 16pt \"MS Shell Dlg 2\";")
        ...
        self.mainTasksView.setColumnCount(3)
        self.mainTasksView.setRowCount(0)
        item = QtWidgets.QTableWidgetItem()
...
"border-radius:15px;")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.todayLbl.setText(_translate("MainWindow", "Today:"))
        item = self.todayTableview.horizontalHeaderItem(0)
        item.setText(_translate("MainWindow", "task"))
        item = self.todayTableview.horizontalHeaderItem(1)
        item.setText(_translate("MainWindow", "difficult"))
        item = self.todayTableview.horizontalHeaderItem(2)
        item.setText(_translate("MainWindow", "deadline"))
        self.maintaskLbl.setText(_translate("MainWindow", "Main:"))
